...
<table width="100%">
  ...
  <tbody>
    ...
    <tr><td><a href="server-connections.md">Server connections</a></td><td>Saved accounts, profile PINs and server integration status</td></tr>
    <tr><td><a href="app-design.md">App design</a></td><td>Shared appearance, components and accessibility</td></tr>
    ...
    <tr><td><a href="playback/README.md">Playback</a></td><td>VividKit, compatible audio, embedded subtitles, chapters, controls and verification</td></tr>
