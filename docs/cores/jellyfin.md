...
- Full on-device settings coverage, saved-account switching, native Apple TV user switching, live tvOS playback and older Jellyfin server versions still need verification. This source integration has not been uploaded to TestFlight.
