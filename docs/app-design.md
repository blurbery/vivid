...
On iPhone, iPad and Apple TV, long-pressing a season opens its native watched/unwatched menu. Series More menus order watched actions as Episode, Season, then Series, targeting the Play/Resume episode. Season writes reuse the existing optimistic episode updates and rollback on failure. On tvOS, browsing episodes leaves the main resume target unchanged. The More menu no longer includes Show Series Info. Episode advancement waits for an unloaded season rather than skipping it, and the movie page responds to the remote Play/Pause button.
