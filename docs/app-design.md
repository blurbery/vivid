...
On iPhone, iPad and Apple TV, the Settings overview joins the circular saved profiles and category rows inside one panel. Usernames stay below avatars, with the saved server name on the next line. The main page shares the secondary pages' header, grouped surface and content width. Apple TV centres the copyright footer beneath the panel. Profile selection, PINs, editing and account isolation retain their existing behaviour.
