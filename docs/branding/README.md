...
The tvOS app-icon foreground is scaled to 82% of its previous size, centred over the unchanged full-size background. Both Home Screen resolutions and the App Store layer use the same vector placement.
