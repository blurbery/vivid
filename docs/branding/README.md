...
<table width="100%">
  ...
  <tbody>
    ...
    <tr><td>Dark-theme compatibility wrapper</td><td><a href="vivid-mark-dark.svg">Transparent vector SVG</a></td><td>Silver</td></tr>
  </tbody>
</table>

The transparent PNG is exported from [the SVG master](vivid-mark-silver.svg) on the existing 1254 × 1254 canvas. A [transparent PDF master](vivid-mark-silver.pdf) is also available. The animation source, website logo and dark-theme compatibility SVG use the same vector-derived silver artwork. The SVG contains Bézier curves and vector shading, with no embedded bitmap.
