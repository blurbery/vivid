...
These are historical records, not a live App Store Connect status feed. Pending checks refer to the stated revision and are not automatically satisfied by a later build. The latest recorded uploads are iPhone/iPad build 20 and tvOS build 19, as recorded above.
