...
The next authorised upload is tvOS-only `0.14.3 (12)`, retaining the tested playback source from build `11` with documentation and build-counter updates. Upload and Apple processing status are recorded after completion. No iOS binary is included.
