...
Series episodes form one native horizontal shelf across seasons. Selecting a season scrolls to its first episode; focusing an episode updates the selected season. The route warms remaining season metadata sequentially in nearby-season order, with only six stills per warmed season. Missing pages retain a Load Season action. Native borderless buttons provide episode artwork focus; cards include episode number, title, summary and date, with watched/resume and context actions retained. The old series page-scroll coordinator, viewport lock, season pager, transition timers and handoff helpers have been removed. Separate episode and season detail pages retain their existing layouts.

The owner supplied an 89-second Bedroom Apple TV reference recording. It establishes the requested appearance and interaction; it does not measure Apple's internal rendering performance. Native navigation, season boundaries in both directions, initial/resume focus, context actions, logo positioning, Reduce Motion, startup and memory require Bedroom verification for this trial. No claim of matching Apple's frame timing is made.
