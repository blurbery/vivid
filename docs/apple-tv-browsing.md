...
Series episodes form one native horizontal shelf across seasons. Focusing a different season automatically scrolls to its first episode; clicking a season also jumps there. Returning focus to the already highlighted season preserves the current episode position. The season selector uses compact native capsule buttons with black labels on their light native background; the selected season retains a subtle capsule when focus moves away. Episode runtime and the watched tick share one compact artwork badge. Focusing an episode updates the selected season. The route warms remaining season metadata sequentially in nearby-season order, with only six stills per warmed season. Missing pages retain a Load Season action. Native borderless buttons provide episode artwork focus; cards include episode number, title, summary and date, with watched/resume and context actions retained. The old series page-scroll coordinator, viewport lock, season pager, transition timers and handoff helpers have been removed. Separate episode and season detail pages retain their existing layouts.
