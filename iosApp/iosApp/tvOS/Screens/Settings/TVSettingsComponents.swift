...
struct TVSettingsRowLabel: View {
    ...
    private static let descriptions: [String: String] = [
        ...
        "Captions": "Choose the text shown beneath Home artwork.",
        "Use Profile Default": "Restore Large posters and Title Only captions on Home.",
    ...
    var body: some View {
        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack(alignment: .leading, spacing: 24) {
                ...
                Text("App privacy information · Updated 7 September 2026")
