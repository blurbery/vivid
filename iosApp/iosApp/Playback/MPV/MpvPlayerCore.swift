...
class MpvPlayerCore: MpvPlayerCoreBase {
  ...
  private weak var vividHostView: UIView?
  ...
  func initialize(in window: UIWindow, hostView: UIView) -> Bool {
    vividHostView = hostView
  ...
  private func refreshExternalDisplayAttachment() {
    ...
    if let externalSuperview {
      ...
      moveContainerView(to: vividHostView ?? window)
