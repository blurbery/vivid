...
struct PlayerSettingsSheet: View {
    ...
    private var subtitleAppearancePage: some View {
        ...
        let editingDisabled = matchesSystem || !viewModel.settings.subtitleUsesDeviceAppearanceOverride
        return List {
            Section {
            ...
            Section {
                ...
                Toggle("Custom Appearance", isOn: Binding(
                ...
                Text(matchesSystem
                     ...
                     : "Text subtitles follow these controls. Styled ASS and image-based subtitles retain their authored appearance and placement.")
            }
