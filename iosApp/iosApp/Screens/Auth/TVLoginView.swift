...
struct TVLoginView: View {
    ...
    private var usesPasswordLogin: Bool { isPasswordPage || MediaServerProvider.active == .emby }
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $showPasswordForm) {
            TVLoginView(router: router, isPasswordPage: true)
        }
