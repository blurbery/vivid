...
public final class AetherEngine: ObservableObject {
    ...
    public func load(
        ...
        let initialOverride = VividInitialAudioStream.resolve(
            explicit: audioSourceStreamIndex, ordinal: options.audioTrackOrdinal,
            streamIndices: probedAudioTracks.map(\.id))
